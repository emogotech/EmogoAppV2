...
class AddCollabCell: UITableViewCell {
    ...
    var lblContact : UILabel = {
        ...
        lbl.font = UIFont(name: kFontBold, size: 14.0)
    ...
    var btnCheck :UIButton = {
        ...
        btn.setImage(UIImage(named:"addCollab_uncheck"), for: .normal)
        return btn
    }()
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        imgProfile.widthAnchor.constraint(equalToConstant: 40).isActive = true
        imgProfile.heightAnchor.constraint(equalToConstant: 40).isActive = true
        imgProfile.centerYAnchor.constraint(equalTo:self.centerYAnchor).isActive = true
        imgProfile.layer.cornerRadius = 20
        
        lblContact.leadingAnchor.constraint(equalTo: self.imgProfile.trailingAnchor, constant: 20).isActive = true
        ...
        lblSeprator.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -30).isActive = true
        lblSeprator.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: 50).isActive = true
