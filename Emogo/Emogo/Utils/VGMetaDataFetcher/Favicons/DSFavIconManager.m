...
- (id)init {
    ...
    if (self) {
        ...
        _placeholder = [UINSImage imageNamed:@"tap"];
...
- (NSArray*)defaultNames {
        return @[@"apple-touch-icon-precomposed.png", @"apple-touch-icon.png", @"touch-icon-iphone.png", @"favicon.ico"];
}

- (NSString *)acceptedRelationshipAttributesRegex {
    NSArray *array;
        array = @[@"apple-touch-icon", @"shortcut icon", @"icon"];
