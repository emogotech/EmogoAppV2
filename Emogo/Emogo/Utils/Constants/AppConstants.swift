...
let kAlert_Save_Image_MyStuff                                             = "Image successfully saved to My Media"
let kAlert_Save_Video_MyStuff                                                   = "Video successfully saved to My Media"
let kAlert_Save_GIF_MyStuff                                                     = "GIF successfully saved to My Media"
let kAlert_Save_Link_MyStuff                                                     = "Link successfully saved to My Media"
