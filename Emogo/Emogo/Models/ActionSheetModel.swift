...
class  ActionSheetModel {
    ...
    func prepareActionSheet(){
               ...
               var menu = Menu(icon: UIImage(named: "grid-2")!, name: "Photos/Videos")
                arrayActions.append(menu)
        
                menu = Menu(icon: UIImage(named: "grid-1")!, name: "Camera")
                ...
                menu = Menu(icon: UIImage(named: "grid-5")!, name: "Gif")
                arrayActions.append(menu)
        
                menu = Menu(icon: UIImage(named: "grid-6")!, name: "My Stuff")
                arrayActions.append(menu)
