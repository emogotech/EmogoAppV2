...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    if ([NSStringFromClass([self.contentViewController class]) isEqualToString: @"InTheKnow.ForwardPostViewController"] || [NSStringFromClass([self.contentViewController class]) isEqualToString: @"InTheKnow.EventFilterViewController"] ){
...
- (void)keyboardWasShown:(NSNotification*)aNotification
{
    ...
    CGRect aRect = self.contentViewController.view.frame;
    aRect.size.height -= kbSize.height;
    CGPoint scrollPoint = CGPointMake(0.0, aRect.size.height);
//    if ([[UIScreen mainScreen] bounds].size.height == 480.0 || [[UIScreen mainScreen] bounds].size.width == 320.0) {
//        scrollPoint =  CGPointMake(0.0, aRect.size.height - 60.0);
//    }
