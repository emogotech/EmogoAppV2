...
internal protocol PMColorPickerDelegate : NSObjectProtocol {
    func colorPickerTouched(sender:PMColorPickerView, color:UIColor, point:CGPoint, state:UIGestureRecognizerState)
}

 @IBDesignable class PMColorPickerView: UIView {

    
    
        weak internal var delegate: PMColorPickerDelegate?
