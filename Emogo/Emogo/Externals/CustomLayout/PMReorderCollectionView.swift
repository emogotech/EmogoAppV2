...
@objc protocol PMDrapDropCollectionViewDelegate {
...
class PMReorderCollectionView: UICollectionView, UIGestureRecognizerDelegate {
    @objc weak var draggingDelegate: PMDrapDropCollectionViewDelegate?
    
    @objc var longPressRecognizer: UILongPressGestureRecognizer = {
    ...
    @objc var draggingView: UIView?
    fileprivate var touchOffsetFromCenterOfCell: CGPoint?
    @objc var isWiggling = false
    fileprivate let pingInterval = 0.0
    @objc var isAutoScrolling = false
    ...
    fileprivate func commonInit() {
        longPressRecognizer.addTarget(self, action: #selector(PMReorderCollectionView.handleLongPress(_:)))
    ...
    @objc func enableDragging(_ enable: Bool) {
        if enable {
...
//AutoScroll
extension PMReorderCollectionView {
...
extension PMReorderCollectionView {
    ...
    @objc func addWiggleAnimationTo(_ cell: UICollectionViewCell) {
        CATransaction.begin()
...
//Assisting Functions
extension PMReorderCollectionView {
    @objc func getRasterizedImageCopyOfCell(_ cell: UICollectionViewCell) -> UIImage {
