...
MSG_FOLDER_NAME_EXISTS = "Folder name already exists, please use a different folder name."
...
MSG_FOLDER_NOT_VALID = "Folder does not exist with id {0}."
...
MSG_STREAM_OWNER_NOT_VALID = "User is not an owner of this emogo."
